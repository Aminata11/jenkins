pipeline {
    ...
    stages {
        stage('Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/Aminata11/jenkins.git'
            }
        }
        ...
        stage('Push Docker Images') {
            steps {
                withCredentials([usernamePassword(credentialsId: 'aminahub', usernameVariable: 'DOCKER_USER', passwordVariable: 'DOCKER_PASS')]) {
                    sh '''
